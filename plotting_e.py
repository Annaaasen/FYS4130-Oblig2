...
mag16 = pd.read_csv("16 magnetisations_vs_T.csv")
gamma16 = mag16["m4"] / mag16["m2"]**2
plt.plot(mag16["T"], gamma16)
# plt.show()

mag8 = pd.read_csv("8 magnetisations_vs_T.csv", header=None, names=["T", "m", "m1", "m2", "m4"])
...
mag32 = pd.read_csv("32 magnetisations_vs_T.csv", header=None, names=["T", "m", "m1", "m2", "m4"])
